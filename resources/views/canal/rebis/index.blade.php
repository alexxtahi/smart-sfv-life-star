...
<script type="text/javascript">
    ...
    function concerneFormatter(id, rows){
        if(rows.concerne=='Agence'){
           return "<span class='text-bold text-green'>Rechargement de l'agence " + rows.libelle_agence + ' N° ' + rows.numero_identifiant_agence + " pour "+rows.libelle_caution_agence+"</span>";
        }
