...
<table id="table" class="table table-warning table-striped box box-primary"
               ...
               data-search="false" 
               data-url="{{url('boutique',['action'=>'liste-retour-materiel'])}}"
               data-toggle="table"
               data-unique-id="id"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="materiel" class="form-control">
                                        ...
                                        @foreach($vente_materiels as $vente_materiel)
                                        <option value="{{$vente_materiel->id}}"> {{$vente_materiel->numero_facture}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
