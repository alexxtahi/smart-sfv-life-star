                ...
                <div class="modal-body ">
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-2">
                           <div class="form-group">
                               <label>Qt&eacute; &agrave; d&eacute;stocker*</label>
                               <input type="number" min="0" name="quantite" ng-model="article.quantite_destocker" class="form-control" id="quantite_add" placeholder="Qté à déstocker" required>
                           </div>
                       </div>
                   </div>
                </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#searchByDate").change(function (e) {
            ...
            if(date == ''){
              ...
              $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-destockages-by-date/' + date});
            }
        }); 
        $("#searchByDepot").change(function (e) {
            ...
            if(depot== 0){
              ...
              $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-destockages-by-depot/' + depot});
            }
        });
        ...
        $(".add-row").click(function () {
            if($("#article").val() != '' && $("#quantite").val() != '' && $("#unite").val() != '' && $("#quantite").val()!=0) {
                ...
                if(parseInt(quantite) > parseInt(stock)){
                    ...
                    var articleTrouver = _.findWhere(lotDestockage, {articles: articleId, unites:uniteId})
                    ...
                    var DataArticle = {'id':idTablle, 'articles':articleId, 'unites':uniteId, 'quantites':quantite};
        ...
        $("#formAjout").submit(function (e) {
            ...
            var $ajaxLoader = $("#formAjout .loader-overlay");
             ...
             if (ajout==true) {
                ...
                var url = "{{route('boutique.destockages.store')}}";
             }else{
               var methode = 'POST';
                var url = "{{route('boutique.update-destockage')}}";
                var formData = new FormData($(this)[0]);
             }
        ...
        $("#formAjoutArticle").submit(function (e) {
            ...
            if (ajoutArticle==true) {
                var methode = 'POST';
                var url = "{{route('boutique.article-destockers.store')}}";
             }else{
    ...
    function updateRow(idDestockage) {
        ...
        $tableArticle.bootstrapTable('refreshOptions', {url: "../boutique/liste-article-destockers/" + idDestockage});
    ...
    function listeArticleRow(idDestockage){
        ...
        $lotDestockageArticle.bootstrapTable('refreshOptions', {url: "../boutique/liste-article-destockers/" + idDestockage});
