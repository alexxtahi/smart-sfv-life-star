    ...
    $(function () {
        ...
        $("#searchByFournisseur").change(function (e) {
            ...
            if(fournisseur == 0){
              ...
              $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-operations-by-caisse-fournisseur/' + caisse + '/' + fournisseur});
            }
        });
        $("#searchByClient").change(function (e) {
            ...
            if(client == 0){
              ...
              $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-operations-by-caisse-client/' + caisse + '/' + client});
            }
        });
