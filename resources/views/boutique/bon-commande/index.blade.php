...
<table id="table" class="table table-warning table-striped box box-primary"
               ...
               data-search="false" 
               data-toggle="table"
               data-url="{{url('boutique',['action'=>'liste-bon-commandes'])}}"
               data-unique-id="id"
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="fournisseur_id" id="fournisseur_id" ng-model="bonCommande.fournisseur_id" ng-init="bonCommande.fournisseur_id=''" class="form-control select2" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="quantite" min="0" placeholder="Qté">
                                </div>
                            </div>
                            <div class="col-md-2">
                   ...
                   <input type="text" class="hidden" id="bon_commande_id"  name="bon_commande_id"/>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Quantit&eacute; *</label>
                                <input type="number" class="form-control" name="quantite" id="quantite_add" min="0" placeholder="Qté" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#fournisseur_id, #article, #article_add").select2({width: '100%'});
        ...
        $("#searchByBonCommande").keyup(function (e) {
            ...
            if(numero_bon == ""){
                $table.bootstrapTable('refreshOptions', {url: "{{url('boutique', ['action' => 'liste-bon-commandes'])}}"});
            }else{
               $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-bon-commandes-by-numero_bon/' + numero_bon});
            }
        });
        $("#searchByDate").change(function (e) {
            ...
            if(date == ""){
               ...
               $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-bon-commandes-by-date/' + date});
            }
        });
        $("#searchByFournisseur").change(function (e) { 
            ...
            if(fournisseur == 0){
              ...
              $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-bon-commandes-by-fournisseur/' + fournisseur});
            }
        });
        ...
        $("#article").change(function (e) {
            var name_article = $("#article").children(":selected").data("libellearticle");
             $("#code_barre").val("");
            $.getJSON("../parametre/article-by-name/" + name_article, function (reponse) {
                if(reponse.total>0){
                    $.each(reponse.rows, function (index, article) { 
        ...
        $("#formAjout").submit(function (e) {
            ...
            if (ajout==true) {
                var methode = 'POST';
                var url = "{{route('boutique.bon-commandes.store')}}";
             }else{
        ...
        $("#formAjoutArticle").submit(function (e) {
            ...
            if (ajoutArticle==true) {
                var methode = 'POST';
                var url = "{{route('boutique.articles-bon.store')}}";
             }else{
    ...
    function bonRow(idBonCommande){
        window.open("../boutique/fiche-bon-commande/" + idBonCommande,'_blank');
    }
    ...
    function optionFormatter(id, row) { 
        if(row.livrer==1){
            return '<span class="text-bold text-green">Bon livré</span>';
        }else{
