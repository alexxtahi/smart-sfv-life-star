                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="qte_vendu" placeholder="Qté" readonly>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                ...
                <div class="modal-body ">
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-1">
                           <div class="form-group">
                               <label>Qt&eacute;</label>
                               <input type="text" class="form-control" id="qte_vendu_add" name="quantite_vendue" ng-model="article.quantite_vendue" placeholder="Qté" readonly>
                           </div>
                       </div>
                       <div class="col-md-2">
                           <div class="form-group">
                               <label>Retour *</label>
                               <input type="number" min="1" name="quantite" class="form-control" ng-model="article.quantite" id="qte_retour_add" placeholder="Qté retorunée" required>
                           </div>
                       </div>
                   </div>
                </div>
...
<script type="text/javascript">
    ...
    function updateRow(idRetourArticle){
        ...
        $("#vente_id").select2("val", retourArticle.vente_id);
