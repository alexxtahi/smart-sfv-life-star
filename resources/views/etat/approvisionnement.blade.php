    ...
    $(function () {
       $table.on('load-success.bs.table', function (e, data) {
        ...
        $("#searchByFournisseur").change(function (e) { 
            ...
            if(fournisseur != 0 && dateDebut!="" && dateFin != ""){
              $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-approvisionnements-by-periode-fournisseur/' + dateDebut + '/' + dateFin + '/' + fournisseur});
            }
        });
        $("#dateDebut, #dateFin").change(function (e) {
            ...
            if(dateDebut!='' && dateFin!=''){
                $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-approvisionnements-by-periode/' + dateDebut + '/' + dateFin});
            }else{
                $table.bootstrapTable('refreshOptions', {url: "{{url('boutique', ['action' => 'liste-approvisionnements'])}}"});
            }
        });
