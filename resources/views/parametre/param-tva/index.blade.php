...
<div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
        <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
            <input type="text" id="idParamTvaModifier" ng-model="paramTva.id" ng-hide="true" class="hidden">
            @csrf
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label for="montant_tva">Libell&eacute;</label>
                        <input type="number" step="0.01" id="montant_tva" name="montant_tva" ng-model="paramTva.montant_tva_convertis" class="form-control" placeholder="Montant de la TVA   Exemple : 18" required>
                    </div>
                </div>
                <!-- /.box-body -->
    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
        <table id="table" class="table table-warning table-striped box box-primary"
            ...
            <thead>
                <tr>
                    <th data-field="montant_tva_convertis" data-formatter="tvaFormatter">Montant TVA  </th>
        ...
        <form id="formSupprimer" ng-controller="formSupprimerCtrl" action="#">
            <div class="modal-content">
                ...
                <div class="modal-body ">
                    ...
                    <div class="clearfix">
                        <div class="text-center question"><i class="fa fa-question-circle fa-2x"></i> Etes vous certains de vouloir supprimer la TVA <br/><b>@{{paramTva.montant_tva_convertis}}%</b></div>
      ...
      $("#formAjout").submit(function (e) {
            ...
            var $ajaxLoader = $("#formAjout .loader-overlay");
             ...
             if (ajout==true) {
                ...
                var id = $("#idParamTvaModifier").val();
                var methode = 'PUT';
                var url = 'param-tva/' + id;
             }
