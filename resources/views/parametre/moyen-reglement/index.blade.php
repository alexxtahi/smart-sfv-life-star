...
<div class="row">
    <div class="col-lg-4 col-md-4 col-sm-4">
        <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
            <input type="text" id="idMoyenReglementModifier" ng-model="moyenReglement.id" ng-hide="true" class="hidden">
            @csrf
      ...
      $("#formAjout").submit(function (e) {
            ...
            var $ajaxLoader = $("#formAjout .loader-overlay");
             ...
             if (ajout==true) {
                ...
                var id = $("#idMoyenReglementModifier").val();
                var methode = 'PUT';
                var url = 'moyen-reglements/' + id;
             }
