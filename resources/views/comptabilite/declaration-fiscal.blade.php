...
<table id="table" class="table table-primary table-striped box box-primary"
               ...
               data-search="false" 
               data-toggle="table"
               data-url="{{url('etat',['action'=>'liste-declaration-ventes'])}}"
       ...
       $table.on('load-success.bs.table', function (e, data) {
        ...
        $("#dateDebut, #dateFin").change(function (e) {
            ...
            if(dateDebut!='' && dateFin!=''){
                $table.bootstrapTable('refreshOptions', {url: '../etat/liste-declaration-ventes-by-periode/' + dateDebut + '/' + dateFin});
            }
            if(dateDebut=='' && dateFin==''){
                $table.bootstrapTable('refreshOptions', {url: "{{url('etat', ['action' => 'liste-declaration-ventes'])}}"});
            }
        });
        ...
        $("#searchByDepot").change(function (e) { 
            ...
            if(dateDebut!='' && dateFin!='' && depot==0){
                $table.bootstrapTable('refreshOptions', {url: '../etat/liste-timbre-ventes-periode/' + dateDebut + '/' + dateFin});
            }
            if(dateDebut=='' && dateFin=='' && depot!=0){
                $table.bootstrapTable('refreshOptions', {url: '../etat/liste-timbre-ventes-by-depot/' + depot});
            }
            if(dateDebut!='' && dateFin!='' && depot!=0){
                $table.bootstrapTable('refreshOptions', {url: '../etat/liste-timbre-ventes-by-periode-depot/' + dateDebut + '/' + dateFin + '/' + depot});
            }
        });
