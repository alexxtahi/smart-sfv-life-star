...
<table id="table" class="table table-primary table-striped box box-primary"
               ...
               data-search="false" 
               data-toggle="table"
               data-url="{{url('etat',['action'=>'liste-timbre-ventes'])}}"
    ...
    $(function () {
       $table.on('load-success.bs.table', function (e, data) {
        ...
        $("#dateDebut, #dateFin").change(function (e) {
            ...
            if(dateDebut=='' && dateFin==''){
                $table.bootstrapTable('refreshOptions', {url: "{{url('etat', ['action' => 'liste-timbre-ventes'])}}"});
            }
        });
...
//        var montantHT  = row.montantTTC/(row.totalTVA+1);
