...
<table id="table" class="table table-warning table-striped box box-primary"
               ...
               data-search="false" 
               data-toggle="table"
               data-url="{{url('boutique',['action'=>'liste-depenses'])}}"
               data-unique-id="id"
        ...
        <form id="formAjout" ng-controller="formAjoutCtrl" action="#">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="text" class="hidden" id="idDepenseModifier" ng-hide="true" ng-model="depense.id"/>
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
    ...
    $(function () {
        ...
        $("#searchByCategorie").change(function (e) {
            ...
            if(categorie == 0 && dateDebut=="" && dateFin==""){
                $table.bootstrapTable('refreshOptions', {url: "{{url('boutique', ['action' => 'liste-depenses'])}}"});
            }
            
            if(categorie != 0 && dateDebut=="" && dateFin==""){
                $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-depenses-by-categorie/' + categorie});
            }
            
            if(categorie == 0 && dateDebut!="" && dateFin!=""){
                $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-depenses-by-periode/' + dateDebut + "/" + dateFin});
            }
            
            if(categorie != 0 && dateDebut!="" && dateFin!=""){
                $table.bootstrapTable('refreshOptions', {url: '../boutique/liste-depenses-by-categorie-periode/' + dateDebut + "/" + dateFin + "/" + categorie});
            }
        ...
        $("#formAjout").submit(function (e) {
            ...
            var $ajaxLoader = $("#formAjout .loader-overlay");
             ...
             if (ajout==true) {
                var methode = 'POST';
                var url = "{{route('boutique.depenses.store')}}";
             }else{
                var id = $("#idDepenseModifier").val();
                var methode = 'PUT';
                var url = 'depenses/' + id;
             }
