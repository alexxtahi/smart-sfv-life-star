    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post') && $request->input('article_id')) {
            ...
            try {
                ...
                $depot = DepotArticle::where([['depot_id', $depot_id], ['article_id', $data["article_id"]], ['unite_id', $data["unite_id"]]])->first();
                ...
                $ArticleDestocker = ArticleDestocker::where([['destockage_id', $data['destockage_id']], ['article_id', $data['article_id']], ['unite_id', $data['unite_id']]])->first();
                if($ArticleDestocker!=null){
                    ...
                    $articleDestocker->unite_id = $data["unite_id"];
                ...
                if ($articleDestockers != null) {
                    $DepotArticle = DepotArticle::where([['depot_id', $depot_id], ['article_id', $data["article_id"]], ['unite_id', $data["unite_id"]]])->first();
                    $mouvementStock = MouvementStock::where([['depot_id', $data['depot_id']],['article_id', $data["article_id"]],['unite_id', $data["unite_id"]]])->whereDate('date_mouvement', $destockage->date_destockage)->first();
    ...
    public function update(Request $request, ArticleDestocker $articleDestocker)
    {
        ...
        if ($articleDestocker) {
            ...
            try {
                ...
                $depot = DepotArticle::where([['depot_id', $depot_id], ['article_id', $articleDestocker->article_id], ['unite_id', $articleDestocker->unite_id]])->first();
                
                $depot->quantite_disponible = $depot->quantite_disponible + $articleDestocker->quantite_destocker;
                $depot->save();
                
                $mouvementStock = MouvementStock::where([['depot_id', $depot_id], ['article_id', $articleDestocker->article_id], ['unite_id', $articleDestocker->unite_id]])->whereDate('date_mouvement', $destockage->date_destockage)->first();
                ...
                if ($articleDestocker != null) {
                    $newDepot = DepotArticle::where([['depot_id', $depot_id], ['article_id', $data["article_id"]], ['unite_id', $data["unite_id"]]])->first();
                    if ($newDepot != null) {
                        $newDepot->quantite_disponible = $newDepot->quantite_disponible - $data["quantite"];
                        $newDepot->save();
                    }
                    
                    $mouvementStock = MouvementStock::where([['depot_id', $depot_id], ['article_id', $data["article_id"]], ['unite_id', $data["unite_id"]]])->whereDate('date_mouvement', $destockage->date_destockage)->first();
                    $mouvementStock->quantite_destocker = $mouvementStock->quantite_destocker + $articleDestocker->quantite_destocker;
                    $mouvementStock->save();
                }
