...
class MoyenReglementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post') && $request->input('libelle_moyen_reglement')) {
            ...
            try {
                ...
                $MoyenReglement = MoyenReglement::where('libelle_moyen_reglement', $data['libelle_moyen_reglement'])->first();
     ...
     * @return Response
     */
    public function update(Request $request, MoyenReglement $moyenReglement)
    {
        ...
        if($moyenReglement){
            try {
                ...
                $search  = array('À', 'Á', 'Â', 'Ã', 'Ä', 'Å', 'Ç', 'È', 'É', 'Ê', 'Ë', 'Ì', 'Í', 'Î', 'Ï', 'Ò', 'Ó', 'Ô', 'Õ', 'Ö', 'Ù', 'Ú', 'Û', 'Ü', 'Ý', 'à', 'á', 'â', 'ã', 'ä', 'å', 'ç', 'è', 'é', 'ê', 'ë', 'ì', 'í', 'î', 'ï', 'ð', 'ò', 'ó', 'ô', 'õ', 'ö', 'ù', 'ú', 'û', 'ü', 'ý', 'ÿ');
                $replace = array('A', 'A', 'A', 'A', 'A', 'A', 'C', 'E', 'E', 'E', 'E', 'I', 'I', 'I', 'I', 'O', 'O', 'O', 'O', 'O', 'U', 'U', 'U', 'U', 'Y', 'a', 'a', 'a', 'a', 'a', 'a', 'c', 'e', 'e', 'e', 'e', 'i', 'i', 'i', 'i', 'o', 'o', 'o', 'o', 'o', 'o', 'u', 'u', 'u', 'u', 'y', 'y');
                $libelle = str_replace($search, $replace, $request->get('libelle_moyen_reglement'));

                $moyenReglement->update([
                    'libelle_moyen_reglement' => strtoupper($libelle),
